        ...
        if 'refine' in modelType or 'final' in modelType:
            ...
            if not separate:
                ...
                if torch.cuda.is_available():
                    ...
                    self.model.load_state_dict(torch.load('checkpoint/pair_' + options.anchorType + '_pair/checkpoint.pth',map_location='cpu'))
                    self.refine_model.load_state_dict(torch.load('checkpoint/instance_normal_refine_mask_softmax_valid/checkpoint_refine.pth',map_location='cpu'))
                pass
            pass
